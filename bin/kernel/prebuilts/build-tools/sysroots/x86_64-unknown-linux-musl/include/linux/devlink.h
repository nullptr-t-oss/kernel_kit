...
enum devlink_attr {
  ...
  DEVLINK_ATTR_INDEX,
  DEVLINK_ATTR_RESOURCE_SCOPE_MASK,
  __DEVLINK_ATTR_MAX,
...
#define DEVLINK_RESOURCE_SCOPE_DEV _BITUL(DEVLINK_RESOURCE_SCOPE_DEV_BIT)
#define DEVLINK_RESOURCE_SCOPE_PORT _BITUL(DEVLINK_RESOURCE_SCOPE_PORT_BIT)
