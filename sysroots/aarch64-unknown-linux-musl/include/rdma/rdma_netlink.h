...
enum rdma_nldev_attr {
  ...
  RDMA_NLDEV_ATTR_FRMR_POOLS,
  RDMA_NLDEV_ATTR_FRMR_POOL_ENTRY,
  RDMA_NLDEV_ATTR_FRMR_POOL_KEY,
  RDMA_NLDEV_ATTR_FRMR_POOL_KEY_ATS,
  RDMA_NLDEV_ATTR_FRMR_POOL_KEY_ACCESS_FLAGS,
  RDMA_NLDEV_ATTR_FRMR_POOL_KEY_VENDOR_KEY,
  RDMA_NLDEV_ATTR_FRMR_POOL_KEY_NUM_DMA_BLOCKS,
  RDMA_NLDEV_ATTR_FRMR_POOL_QUEUE_HANDLES,
  RDMA_NLDEV_ATTR_FRMR_POOL_MAX_IN_USE,
  RDMA_NLDEV_ATTR_FRMR_POOL_IN_USE,
  RDMA_NLDEV_ATTR_FRMR_POOLS_AGING_PERIOD,
